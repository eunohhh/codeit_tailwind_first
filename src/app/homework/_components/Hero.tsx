      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900 leading-[3rem]">
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <Link
                ...
                href="#"
              >
                <AppDownload className="h-10 w-auto" />
              </Link>
              <Link
                className="inline-flex justify-center rounded-lg border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm transition-colors border-gray-300 text-gray-700 hover:border-gray-400 active:bg-gray-100 active:text-gray-700/80"
                href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"
              >
                <Play className="h-6 w-6 flex-none" />
                            ...
                            <svg viewBox="0 0 286 208" className="overflow-visible">
                              <defs>
                                ...
                                >
                                  ...
                                  <stop offset="100%" stopColor="#13B5C8" stopOpacity="0"></stop>
                                </linearGradient>
                              </defs>
                              <line
                                stroke="#a3a3a3"
