...
function ScrollingWavePage() {
  ...
  // useMotionValue 는 set시 애니메이션 없이 즉시 바뀜
  // useSpring 은 set시 애니메이션 있이 바뀜
  ...
  // 아래 useTransform 은 굳이 안하고 useSpring 값 바로 써도 똑같음
  // const textStyle = useTransform(textValue, () => `${textValue.get()}%`);
